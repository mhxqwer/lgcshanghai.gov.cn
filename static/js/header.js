...
document.writeln("          <a id=\'accesshelp\' title=\'新窗口打开无障碍操作说明页面\' href=\'https://voice.ewdcloud.com/wzagjt/reference.html\' target=\'_blank\'>无障碍操作说明</a>");
...
document.writeln("                  <li>");
document.writeln("                    <a href=\'https://english.shanghai.gov.cn\' title=\'ENGLISH\'><i class=\'iconfont icon-wangzhi_huaban\'></i>ENGLISH</a>");
document.writeln("                  </li>");
document.writeln("	          <li>");
document.writeln("	            <a href=\'https://japanese.shanghai.gov.cn\' title=\'日本語\'>日本語</a>                ");
document.writeln("	          </li>");
document.writeln("                  <li>");
document.writeln("	            <a href=\'https://korean.shanghai.gov.cn\' title=\'한국어\'>한국어</a>                ");
document.writeln("	          </li>");
document.writeln("                <li><a href=\'https://german.shanghai.gov.cn/\' title=\'DEUTSCH\'>DEUTSCH</a></li>");
document.writeln("                  <li>");
document.writeln("                    <a href=\'https://french.shanghai.gov.cn/\' title=\'FRANÇAIS\'>FRANÇAIS</a>");
document.writeln("                  </li>");
document.writeln("                  <li>");
document.writeln("                    <a href=\'https://spanish.shanghai.gov.cn/\' title=\'ESPAÑOL\'>ESPAÑOL</a>");
document.writeln("                  </li> ");
document.writeln("                  <li>");
document.writeln("                    <a href=\'https://portuguese.shanghai.gov.cn/\' title=\'PORTUGUÊS\'>PORTUGUÊS</a>");
document.writeln("                  </li>");
document.writeln("                  <li>");
document.writeln("                    <a href=\'https://russian.shanghai.gov.cn/\' title=\'РУССКИЙ\'>РУССКИЙ</a>");
document.writeln("                  </li>");
document.writeln("                  <li>");
document.writeln("                    <a href=\'https://arabic.shanghai.gov.cn/\' title=\'العربية\'>العربية</a>");
document.writeln("                  </li>");
document.writeln("                </ul>");
document.writeln("              </div>");
document.writeln("	      </div>");
