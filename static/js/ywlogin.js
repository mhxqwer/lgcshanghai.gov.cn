...
//底部友情链接alt+上下键打开关闭
      const customSelects = document.querySelectorAll('.footer-links>li');
     customSelects.forEach(function(customSelect) {
     
             const anchorTags = customSelect.querySelectorAll(' .dropdown>a');
             var activefocus;
         document.addEventListener('keydown', function(event) {
           ...
           if (event.altKey && event.key === 'ArrowUp') {
                     anchorTags.forEach(function(anchorTag) {
                         ...
                         if (anchorTag === document.activeElement ) {
                          anchorTag.nextElementSibling.style.display='block' // 按下 Alt+方向键上时展开下拉框   
                           }
                     });
                 }
                 ...
                 if (event.altKey && event.key === 'ArrowDown') {
                     ...
                     anchorTags.forEach(function(anchorTag) {
                       activefocus =document.activeElement.parentElement.parentElement.parentElement.firstElementChild
                       if (anchorTag === activefocus) {
                             activefocus.focus();
                             anchorTag.nextElementSibling.style.display='none'// 按下 Alt+方向键下时关闭下拉框
                           }
                     });
                 }
             });
